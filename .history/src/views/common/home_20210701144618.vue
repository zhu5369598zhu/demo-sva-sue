  ...
  <div class="box">
    <div class="nav">
      <div class="change-type">
        <div class="type-left">
          <ul>
            <li><a>导航1</a><span></span></li>
            <li><a>导航2</a><span></span></li>
            <li><a>导航3</a><span></span></li>
            <li><a>导航4</a><span></span></li>
            <li><a>导航5</a><span></span></li>
            <li><a>导航6</a><span></span></li>
            <li><a>导航7</a><span></span></li>
          </ul>
        </div>
 ...
 created () {
  ...
  methods: {
    ...
    getDeviceStatus () {//设备状态
        ...
        series: [
          {
            ...
            type: 'pie',
            radius: ['36%', '45%'],
            color: ['#b1b712', '#1dadff', '#24dcf7', '#c37a1c', '#1c8ac3', '#12b796'],
            center: ['50%', '43%'],
      ...
      this.deviceStatusLine = echarts.init(document.getElementById('deviceStatus'))
    ...
    getAbnormal () {//异常排名
      var option = {
        ...
        yAxis: {
          type: 'category',
          data: ['No.1 异常名称', 'No.1 异常名称', 'No.1 异常名称', 'No.1 异常名称', 'No.1 异常名称'],
          axisLine: {
            show: false
          },
          axisTick: {
    ...
    getAbnormalTrend () {//异常趋势
      ...
      this.abnormalTrend = echarts.init(document.getElementById('abnormalTrend'))
