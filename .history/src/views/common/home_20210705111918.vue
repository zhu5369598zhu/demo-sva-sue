      ...
      <div class="maint">
        <div class="mt1">
          ...
          <div class="tit_box">
            ...
            <div class="btn_box">
              <div @click="getAbnormalTrend('week')" class="titr_btn" :class="active1=='week'?'btnA':''">状态</div>
              <div @click="getAbnormalTrend('month')" class="titr_btn" :class="active1=='month'?'btnA':''">等级</div>
              <div @click="getAbnormalTrend('year')" class="titr_btn" :class="active1=='year'?'btnA':''">部门</div>
            </div>
          </div>
