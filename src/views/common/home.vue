  ...
  <div class="box">
    ...
    <div class="head">
      ...
      <div class="head_btn_l">
        <div class="screen_btn" @click="">首页</div>
      ...
      <div class="work_box">
        <div class="work_order">
          ...
          <div class="work_lsit">
            <div
              class="work_item"
              @click="linkWork('management-ordermanagementalready')"
            >
              待受理： {{ orderAlreadyCount }}条
            </div>
            <div
              class="work_item"
              @click="linkWork('management-ordermanagementreported')"
            >
              待上报： {{ orderReportedCount }}条
            </div>
            <div
              class="work_item"
              @click="linkWork('management-ordermanagementconfirm')"
            >
              待审核： {{ orderConfirmCount }}条
            </div>
          </div>
        </div>
        <div class="work_order">
          ...
          <div class="work_lsit">
            <div
              class="work_item"
              @click="linkWork('management-orderdefective')"
            >
              填报缺陷： {{ defectiveCount }}条
            </div>
            <div class="work_item" @click="linkWork('management-orderdefect')">
