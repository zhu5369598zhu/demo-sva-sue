<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-row>
         <el-col :span="8">
          <el-form-item label="资产名称:" prop="propertyName">
            <el-input size="mini" v-model="dataForm.propertyName" placeholder="资产名称" clearable style="width:140px;"></el-input>
          </el-form-item>
        </el-col> 
        <el-col :span="8">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="规格型号:" prop="deviceUnit">
      ...
      <el-row>
        ...
        <el-col :span="6">
         ...
         <el-col :span="6">
        <el-form-item label="点检卡码" prop="cardCode">
          <el-input v-model="dataForm.cardCode" placeholder="点检卡码" size="mini"></el-input>
        </el-form-item>
      </el-col>
      ...
      getRfid () {
        this.$http({
          ...
          if (data && data.code === 0 && data.bind !== null) {
            this.dataForm.cardCode = data.bind.content
          } else {
            this.setTimer()
          }
        })
