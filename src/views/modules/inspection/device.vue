    ...
    methods: {
      ...
      exportToExcel (list) {
        ...
        require.ensure([], () => {
          ...
          const tHeader = ['设备名称<device_name>', '资产名称<property_name>','设备等级<device_level_name>', '所属机构<dept_name>', '生产日期<manufacture_date>', '设备编号<device_num>', '设备编码<device_code>', '设备规格<device_unit>', '生产厂家<device_manufacturer>', '供货商<device_supplier>', '设备模型<device_model>', '责任人<device_master>', '巡区<zone_name>', '是否巡检<is_inspect>', '看板显示<is_show_dashboard>','点检卡码<card_code>']
          const filterVal = ['deviceName', 'propertyName', 'deviceLevelName', 'deptName', 'manufactureDate', 'deviceNum', 'deviceCode', 'deviceUnit', 'deviceManufacturer', 'deviceSupplier', 'deviceModel', 'deviceMaster', 'zones', 'isInspectName', 'isShowDashboardName','cardCode']
