  ...
  <div class="show-data-down" style="flex: 1;display: flex;flex-direction: column;">
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="mini" @click="timeAddOrUpdateHandle(scope.row.id)">绑定巡项</el-button>
    ...
    <!-- 弹窗, 新增 / 修改 -->
     <addUpdate
              v-if="timeAddUpdateVisible"
              ref="addUpdate"
              @refreshDataList="getTimeList"
            ></addUpdate>
  ...
  export default {
    ...
    methods: {
      ...
      zoneAddOrUpdateHandle (id) {
       ...
       // 新增 / 修改
      timeAddOrUpdateHandle (id) {
        console.log(id)
        this.timeAddUpdateVisible = true
        this.$nextTick(() => {
